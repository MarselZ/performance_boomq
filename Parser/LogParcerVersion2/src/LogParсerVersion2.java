...
public class LogParсerVersion2 {

    public static void main(String[] args) {
        String inputFile = "C:\\Users\\Bogdan\\Desktop\\3monthslog.txt";
        String outputFile = "C:\\Users\\Bogdan\\resultWithoutIf.csv";
        ...
        //мапа для подсчета общего числа операций

        HashMap<String, Integer> operAll = new HashMap<>();
        operAll.put("команда создана в графане", 0);
        operAll.put("подписка для команды создана", 0);
        operAll.put("зарегистрировался", 0);
        operAll.put("команда создана", 0);
        operAll.put("запустил test", 0);
        operAll.put("перешел в status TEST_STOPPING", 0);
        operAll.put("перешел в status CANCELED", 0);
        operAll.put("перешел в status FINISHED", 0);
        operAll.put("обновил подписку", 0);
        operAll.put("перешел в status FAILED", 0);
        operAll.put("ошибка регистрации", 0);
        operAll.put("стартовал grafana platform", 0);
