# 1 "d:\\project nt 2024\\scripts\\uc06_create_report\\\\combined_UC06_Create_report.c"
...
# 1 "d:\\project nt 2024\\scripts\\uc06_create_report\\\\combined_UC06_Create_report.c" 2
...
# 2 "d:\\project nt 2024\\scripts\\uc06_create_report\\\\combined_UC06_Create_report.c" 2
...
# 3 "d:\\project nt 2024\\scripts\\uc06_create_report\\\\combined_UC06_Create_report.c" 2
...
# 4 "d:\\project nt 2024\\scripts\\uc06_create_report\\\\combined_UC06_Create_report.c" 2
...
# 176 "Action.c"
	...
	lr_end_transaction("UC06_TR01_login",2);
	...
	lr_end_transaction("UC06_TR02_reports",2);
	...
	lr_end_transaction("UC06_TR03_add_new_report",2);
...
# 354 "Action.c"
	lr_end_transaction("UC06_TR05_reportname",2);

	lr_start_transaction("UC06_TR06_sign_out");

	lr_end_transaction("UC06_TR06_sign_out",2);

	return 0;
}
# 5 "d:\\project nt 2024\\scripts\\uc06_create_report\\\\combined_UC06_Create_report.c" 2
...
# 6 "d:\\project nt 2024\\scripts\\uc06_create_report\\\\combined_UC06_Create_report.c" 2
