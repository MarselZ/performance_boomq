# 1 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc01_user_registration\\\\combined_UC01_User_registration.c"
...
# 1 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc01_user_registration\\\\combined_UC01_User_registration.c" 2
...
# 2 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc01_user_registration\\\\combined_UC01_User_registration.c" 2
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"fbe6d3b848e54e78ada93dc1986445bd\",\"statu"
...
# 3 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc01_user_registration\\\\combined_UC01_User_registration.c" 2
...
# 4 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc01_user_registration\\\\combined_UC01_User_registration.c" 2
...
{ int randomNumber;
 char *one,*two,*three,*four,*five;
	...
	lr_end_transaction("UC_01_TR_02_Going_to_group",2);
	...
	lr_end_transaction("UC_01_TR_05_Add_member",2);
	...
	lr_end_transaction("UC_01_TR_06_Copy_invite_link",2);

	lr_start_transaction("UC_01_TR_07_Exit");
	
	lr_think_time(5);
	
	lr_end_transaction("UC_01_TR_07_Exit",2);
	...
	lr_end_transaction("UC_01_TR_08_Insert_invite_link",2);
	...
	lr_end_transaction("UC_01_TR_09_Input_password",2);

	lr_start_transaction("UC_01_TR_10_Exit");
	
	lr_think_time(rand()%5 + 5);
	
	lr_end_transaction("UC_01_TR_10_Exit",2);

	return 0;
}
# 5 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc01_user_registration\\\\combined_UC01_User_registration.c" 2
...
# 6 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc01_user_registration\\\\combined_UC01_User_registration.c" 2
