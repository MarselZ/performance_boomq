# 1 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc05_create_trend\\\\combined_UC05_Create_trend.c"
# 1 "D:\\RL\\LOADRUNNER\\include/lrun.h" 1
...
# 103 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 273 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
int   lr_debug_message (unsigned int msg_class,
									    char * format,
										...);
# 513 "D:\\RL\\LOADRUNNER\\include/lrun.h"
void   lr_new_prefix (int type,
                                 char * filename,
                                 int line);
# 516 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 540 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
int   lr_eval_string_ext (const char *in_str,
                                     ...
                                     const char *file,
								     long const line);
# 574 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
int lr_param_increment (char * dst_name,
                              char * src_name);
# 597 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
int	  lr_save_var (char *              param_val,
							  ...
							  unsigned long const options,
							  char *			  param_name);
# 621 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 700 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
int lr_table_get_column_name_by_index (char * param_name, int col, 
											char * * const col_name,
											size_t * col_name_len);
# 761 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 776 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 800 "D:\\RL\\LOADRUNNER\\include/lrun.h"
void   lr_param_substit_free (char * * pstr);


 
# 812 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
char *   lrfnc_eval_string (char * str,
                                      char * file_name,
                                      long const line_num);
# 820 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
int   lrfnc_save_string ( const char * param_val,
                                     ...
                                     long const line_num);
# 826 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 929 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
int   lr_save_value (char * param_val,
                                ...
                                char * file_name,
                                long const line_num);
# 936 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
int   lr_set_debug_message (unsigned int msg_class,
                                       unsigned int swtch);
# 958 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 1034 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 1063 "D:\\RL\\LOADRUNNER\\include/lrun.h"


# 1075 "D:\\RL\\LOADRUNNER\\include/lrun.h"
...
# 1 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc05_create_trend\\\\combined_UC05_Create_trend.c" 2

# 1 "D:\\RL\\LOADRUNNER\\include/SharedParameter.h" 1
...
# 100 "D:\\RL\\LOADRUNNER\\include/SharedParameter.h"
...
# 2 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc05_create_trend\\\\combined_UC05_Create_trend.c" 2
...
# 1 "D:\\RL\\LOADRUNNER\\include/web_api.h" 1
...
# 1 "D:\\RL\\LOADRUNNER\\include/as_web.h" 1
...
# 789 "D:\\RL\\LOADRUNNER\\include/as_web.h"


# 802 "D:\\RL\\LOADRUNNER\\include/as_web.h"
...
# 840 "D:\\RL\\LOADRUNNER\\include/as_web.h"
...
# 908 "D:\\RL\\LOADRUNNER\\include/as_web.h"
...
# 9 "D:\\RL\\LOADRUNNER\\include/web_api.h" 2
...
# 1 "D:\\RL\\LOADRUNNER\\include/lrw_custom_body.h" 1
...
char WebSocketReceive0[] = "{\"messageType\":\"hello\",\"uaid\":\"0e3bb0a40b3e431a9b379bad4d8571d4\",\"statu"
...
# 3 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc05_create_trend\\\\combined_UC05_Create_trend.c" 2
...
# 4 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc05_create_trend\\\\combined_UC05_Create_trend.c" 2
...
{	
	...
	web_websocket_send("ID=1", 
		"Buffer={\"messageType\":\"hello\",\"broadcasts\":{\"remote-settings/monitor_changes\":\"\\\"1718777113320\\\"\"},\"use_webpush\":true}", 
		"IsBinary=0", 
		"LAST");
	...
	web_url("4aavslhx.791095574.xyz", 
		"URL=https://4aavslhx.791095574.xyz/", 
		"TargetFrame=", 
		"Resource=0", 
	...
	web_url("extensive", 
		"URL=https://4aavslhx.791095574.xyz/v2/network/info/leading/extensive", 
		"TargetFrame=", 
		"Resource=0", 
		"RecContentType=application/json", 
		"Referer=", 
	...
	lr_start_transaction("UC05_TR02_Go_Trending");
	...
	lr_end_transaction("UC05_TR02_Go_Trending",2);
	...
	lr_end_transaction("UC05_TR03_Add_new_trend_report",2);

	lr_think_time(rand()%10 + 5);

	lr_start_transaction("UC05_TR04_Select_test");
	...
	lr_end_transaction("UC05_TR04_Select_test",2);

	lr_start_transaction("UC05_TR05_Select_test_runs");

	lr_end_transaction("UC05_TR05_Select_test_runs",2);

	lr_start_transaction("UC05_TR06_Next");
	...
	lr_end_transaction("UC05_TR06_Next",2);

	lr_start_transaction("UC05_TR07_Add_Chart");
	...
	lr_end_transaction("UC05_TR07_Add_Chart",2);

	lr_think_time(rand()%10 + 5);

	lr_start_transaction("UC05_TR08_Add_table");
	...
	lr_end_transaction("UC05_TR08_Add_table",2);

	lr_think_time(rand()%5 + 5);

	lr_start_transaction("UC05_TR09_Save");
	...
	web_custom_request("slaReportProfile_2", 
		...
		"Mode=HTML", 
		"EncType=application/json", 
		"Body={\"name\":\"untitled_profile_{time}\",\"projectId\":2519,\"chartProfileList\":[{\"slaTypeList\":[{\"fromDate\":0,\"restrictionType\":\"AVERAGE\",\"targetType\":\"TEST\",\"toDate\":360,\"type\":\"GENERAL_SLA_TYPE\"},{\"fromDate\":0,\"restrictionType\":\"ERROR_RATE\",\"targetType\":\"TEST\",\"toDate\":360,\"type\":\"GENERAL_SLA_TYPE\"}],\"orderInReport\":0}],\"tableProfileList\":[{\"tableId\":null,\"slaTypeList\":[{\"fromDate\":0,\"restrictionType\":\"AVERAGE\",\"targetType\":\"TEST\",\"toDate\""
	...
	lr_end_transaction("UC05_TR09_Save",2);

	lr_start_transaction("UC05_TR10_Exit");

	lr_end_transaction("UC05_TR10_Exit",2);

	return 0;
}
# 5 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc05_create_trend\\\\combined_UC05_Create_trend.c" 2
...
# 6 "d:\\project nt 2024\\\361\352\360\350\357\362\373\\scripts4stability\\uc05_create_trend\\\\combined_UC05_Create_trend.c" 2
