...
{	
	...
	lr_end_transaction("UC05_TR02_Go_Trending",LR_AUTO);
	...
	lr_end_transaction("UC05_TR04_Select_test",LR_AUTO);

	lr_start_transaction("UC05_TR05_Select_test_runs");

	lr_end_transaction("UC05_TR05_Select_test_runs",LR_AUTO);
	...
	lr_end_transaction("UC05_TR06_Next",LR_AUTO);
	...
	lr_end_transaction("UC05_TR07_Add_Chart",LR_AUTO);
	...
	lr_end_transaction("UC05_TR08_Add_table",LR_AUTO);
	...
	//untitled_profile_13:25

	lr_end_transaction("UC05_TR09_Save",LR_AUTO);

	lr_start_transaction("UC05_TR10_Exit");

	lr_end_transaction("UC05_TR10_Exit",LR_AUTO);
